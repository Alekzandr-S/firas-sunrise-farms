...
export function Header() {
  return (
    ...
    >
      <div 
        className="sm:containe max- sm:maxw-4xl text-center"
      >
        <motion.h1 
          className="mb-5 mx-auto xs:max-w[50px] sm:maxw-2xl text6xl text-[clamp(1.5rem,4vw,10rem)] font-bold md:mb-6 md:text9xl lg:text10xl"
